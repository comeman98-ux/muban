...
export const positionSizingContent = {
  zh: {
    title: '仓位控制与资金管理 - 凯利公式与动态仓位调整策略 | 富利者',
    ...
    ctaTitle: '想要优化你的仓位管理？',
    ctaDescription: '使用 富利者 专业仓位计算工具，实现自动化风险控制',
  ...
  en: {
    title: 'Position Sizing & Money Management - Kelly Criterion & Dynamic Position Strategies | 富利者',
    ...
    ctaDescription: 'Use 富利者 professional position calculation tools for automated risk control',
