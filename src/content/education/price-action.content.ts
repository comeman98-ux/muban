...
export const priceActionContent = {
  zh: {
    title: '价格行为交易策略 - Pin Bar、Inside Bar、供需区域完整指南 | 富利者',
    ...
    ctaDescription: '加入富利者专业培训，学习裸K交易和供需区域策略',
  ...
  en: {
    title: 'Price Action Trading Strategy - Pin Bar, Inside Bar, Supply/Demand Zones Guide | 富利者',
    ...
    ctaDescription: 'Join 富利者 professional training to learn naked trading and supply/demand strategies',
