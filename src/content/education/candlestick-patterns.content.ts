...
export const candlestickPatternsContent = {
  zh: {
    title: 'K线形态识别指南 - Doji、Hammer、Engulfing等反转与持续形态详解 | 富利者',
    ...
    ctaDescription: '加入富利者培训计划，获取专业K线分析工具和实战指导',
  ...
  en: {
    title: 'Candlestick Patterns Guide - Doji, Hammer, Engulfing Reversal & Continuation Patterns | 富利者',
    ...
    ctaDescription: 'Join 富利者 training for professional candlestick analysis tools and practical guidance',
