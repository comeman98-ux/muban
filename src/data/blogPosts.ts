...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">富利者采用军事化管理模式，因为我们深知：交易是一场心理战争，需要极强的纪律性、执行力和心理素质。我们的培训不是教你如何快速致富，而是培养你成为一名专业的、可持续盈利的交易员。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">富利者采用分润制度，你的收入完全取决于你的交易盈利。我们不收取任何培训费用，也不要求你投入自己的资金。公司提供配资，你只需专注于交易。</p>
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">💡 富利者推荐：波段交易策略</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">某富利者学员的真实交易记录（已脱敏）</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
